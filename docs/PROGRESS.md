...
| 桥 action | — | **267** |
| 测试 | 0 | **835 项 / 39 文件**（其中 7 个文件不需要 WPS，已进 CI） |
...
**835/0**、一键 e2e **28/28** 全绿，可以开始小范围推广；第 2～4 波（S3 数据安全 / S4 冒烟矩阵 /
S5 空 catch / S6 失败契约 / S7 文案 / S8 版本检查 / S9 安装兜底）与审计 P2 已全部落地，尚未打包成版本。
