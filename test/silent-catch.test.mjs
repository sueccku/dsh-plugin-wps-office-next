...
const ALLOWLIST = {
  "mcp/scripts/wps-com.ps1": {
    ...
    "} catch { }": { count: 5, reason: "function-level fallback: Get-WpsApp / Get-RangeAddressSafe / Get-ListObjectAddress / Get-WpsRangeImpact fall back to a default when the read fails" },
