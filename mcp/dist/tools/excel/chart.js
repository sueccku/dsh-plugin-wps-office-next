...
exports.chartTools = exports.exportRangeAsImageHandler = exports.exportRangeAsImageDefinition = exports.exportChartAsImageHandler = exports.exportChartAsImageDefinition = exports.updateChartHandler = exports.updateChartDefinition = exports.createChartHandler = exports.createChartDefinition = exports.ChartType = void 0;
...
(function (ChartType) {
    /** 簇状柱形图 - 最常用的，比较数值大小 */
    ChartType["COLUMN_CLUSTERED"] = "column_clustered";
    /** 堆积柱形图 - 看整体和部分关系 */
    ChartType["COLUMN_STACKED"] = "column_stacked";
    /** 簇状条形图 - 横着的柱形图 */
    ChartType["BAR_CLUSTERED"] = "bar_clustered";
    /** 折线图 - 看趋势变化 */
    ChartType["LINE"] = "line";
    /** 带数据标记的折线图 */
    ChartType["LINE_MARKERS"] = "line_markers";
    /** 饼图 - 看占比 */
    ChartType["PIE"] = "pie";
    /** 环形图 - 空心饼图 */
...
exports.createChartHandler = createChartHandler;
/**
 * 更新图表属性工具
 * 支持修改标题、颜色、图例、数据标签等属性
 */
exports.updateChartDefinition = {
...
exports.updateChartHandler = updateChartHandler;
// ==================== 3. 导出图表为图片 ====================
/**
 * 将指定图表导出为位图图片
 *
 ...
 */
exports.exportChartAsImageDefinition = {
...
const exportChartAsImageHandler = async (args) => {
    const { chartName, outputPath, format, sheet } = args;
...
exports.exportChartAsImageHandler = exportChartAsImageHandler;
// ==================== 4. 导出区域为图片 ====================
/**
 * 将指定区域导出为位图图片
 *
 ...
 */
exports.exportRangeAsImageDefinition = {
...
const exportRangeAsImageHandler = async (args) => {
    const { range, outputPath, format, sheet } = args;
...
exports.exportRangeAsImageHandler = exportRangeAsImageHandler;
/**
 * 导出所有图表相关的Tools
 */
exports.chartTools = [
    { definition: exports.createChartDefinition, handler: exports.createChartHandler },
    { definition: exports.updateChartDefinition, handler: exports.updateChartHandler },
    { definition: exports.exportChartAsImageDefinition, handler: exports.exportChartAsImageHandler },
    { definition: exports.exportRangeAsImageDefinition, handler: exports.exportRangeAsImageHandler },
];
exports.default = exports.chartTools;
