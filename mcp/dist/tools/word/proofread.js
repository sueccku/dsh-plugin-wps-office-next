...
exports.proofreadTools = exports.proofreadBasicHandler = exports.proofreadBasicDefinition = exports.replaceRangeHandler = exports.replaceRangeDefinition = exports.getTrackChangesStatusHandler = exports.getTrackChangesStatusDefinition = exports.enableTrackChangesHandler = exports.enableTrackChangesDefinition = void 0;
const uuid_1 = require("uuid");
const tools_1 = require("../../types/tools");
const wps_client_1 = require("../../client/wps-client");
const wps_1 = require("../../types/wps");
exports.enableTrackChangesDefinition = {
...
const enableTrackChangesHandler = async (args) => {
    const { enable } = args;
    const enabled = typeof enable === 'boolean' ? enable : true;
    try {
        const response = await wps_client_1.wpsClient.executeMethod('enableTrackChanges', { enable: enabled }, wps_1.WpsAppType.WRITER);
...
exports.enableTrackChangesHandler = enableTrackChangesHandler;
exports.getTrackChangesStatusDefinition = {
...
const getTrackChangesStatusHandler = async (_args) => {
    try {
        const response = await wps_client_1.wpsClient.executeMethod('getTrackChangesStatus', {}, wps_1.WpsAppType.WRITER);
        if (response.success && response.data) {
...
exports.getTrackChangesStatusHandler = getTrackChangesStatusHandler;
exports.replaceRangeDefinition = {
...
exports.replaceRangeHandler = replaceRangeHandler;
exports.proofreadBasicDefinition = {
...
function runBasicProofreading(text, baseOffset = 0) {
    const issues = [];
    const rules = [
        {
...
const proofreadBasicHandler = async (args) => {
    const { text, start_offset } = args;
    if (!text || text.trim() === '') {
        return {
            id: (0, uuid_1.v4)(),
            success: false,
    ...
    try {
        ...
        const lines = issues.map((issue, i) => `${i + 1}. [${issue.type}] 位置 ${issue.offset}\n` +
            `   原文: "${issue.original}"\n` +
            `   建议: "${issue.suggestion}"\n` +
            `   上下文: ${issue.context}`);
        return {
...
exports.proofreadBasicHandler = proofreadBasicHandler;
exports.proofreadTools = [
    { definition: exports.enableTrackChangesDefinition, handler: exports.enableTrackChangesHandler },
    { definition: exports.getTrackChangesStatusDefinition, handler: exports.getTrackChangesStatusHandler },
    { definition: exports.replaceRangeDefinition, handler: exports.replaceRangeHandler },
    { definition: exports.proofreadBasicDefinition, handler: exports.proofreadBasicHandler },
];
exports.default = exports.proofreadTools;
//# sourceMappingURL=proofread.js.map