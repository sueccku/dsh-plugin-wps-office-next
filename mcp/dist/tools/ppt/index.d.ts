...
export { addSlideDefinition, addSlideHandler, beautifyDefinition, beautifyHandler, unifyFontDefinition, unifyFontHandler, alignObjectsDefinition, alignObjectsHandler, setFontColorDefinition, setFontColorHandler, } from './slide';
export { deleteSlideDefinition, deleteSlideHandler, duplicateSlideDefinition, duplicateSlideHandler, moveSlideDefinition, moveSlideHandler, getSlideCountDefinition, getSlideCountHandler, getSlideInfoDefinition, getSlideInfoHandler, switchSlideDefinition, switchSlideHandler, setSlideLayoutDefinition, setSlideLayoutHandler, getSlideNotesDefinition, getSlideNotesHandler, setSlideNotesDefinition, setSlideNotesHandler, addShapeDefinition, addShapeHandler, setShapeStyleDefinition, setShapeStyleHandler, addTextboxDefinition, addTextboxHandler, setSlideTitleDefinition, setSlideTitleHandler, insertImageDefinition, insertImageHandler, setShapeTextDefinition, setShapeTextHandler, setAnimationDefinition, setAnimationHandler, setBackgroundDefinition, setBackgroundHandler, setSlideSizeDefinition, setSlideSizeHandler, addChartDefinition, addChartHandler, addSpeakerNotesDefinition, addSpeakerNotesHandler, setShapeFillDefinition, setShapeFillHandler, setTransitionDefinition, setTransitionHandler, } from './slide-ops';
export { createPresentationDefinition, createPresentationHandler, openPresentationDefinition, openPresentationHandler, closePresentationDefinition, closePresentationHandler, getOpenPresentationsDefinition, getOpenPresentationsHandler, switchPresentationDefinition, switchPresentationHandler, setSlideThemeDefinition, setSlideThemeHandler, copySlideDefinition, copySlideHandler, insertSlideImageDefinition, insertSlideImageHandler, insertSlidesFromFileDefinition, insertSlidesFromFileHandler, setActiveTargetDefinition, setActiveTargetHandler, } from './presentation';
...
export { insertPptChartDefinition, insertPptChartHandler, setPptChartDataDefinition, setPptChartDataHandler, setPptChartStyleDefinition, setPptChartStyleHandler, createFlowChartDefinition, createFlowChartHandler, createOrgChartDefinition, createOrgChartHandler, createTimelineDefinition, createTimelineHandler, } from './chart-flow';
export { getSlideMasterDefinition, getSlideMasterHandler, setMasterBackgroundDefinition, setMasterBackgroundHandler, addMasterElementDefinition, addMasterElementHandler, set3DRotationDefinition, set3DRotationHandler, set3DDepthDefinition, set3DDepthHandler, set3DMaterialDefinition, set3DMaterialHandler, create3DTextDefinition, create3DTextHandler, addPptHyperlinkDefinition, addPptHyperlinkHandler, removePptHyperlinkDefinition, removePptHyperlinkHandler, findPptTextDefinition, findPptTextHandler, replacePptTextDefinition, replacePptTextHandler, startSlideShowDefinition, startSlideShowHandler, } from './misc';
export { createProgressBarDefinition, createProgressBarHandler, createGaugeDefinition, createGaugeHandler, createMiniChartsDefinition, createMiniChartsHandler, createDonutChartDefinition, createDonutChartHandler, autoLayoutDefinition, autoLayoutHandler, smartDistributeDefinition, smartDistributeHandler, createGridDefinition, createGridHandler, } from './data-viz';
...
export { applyColorSchemeDefinition, applyColorSchemeHandler, autoBeautifySlideDefinition, autoBeautifySlideHandler, beautifyAllSlidesDefinition, beautifyAllSlidesHandler, createKpiCardsDefinition, createKpiCardsHandler, createStyledTableDefinition, createStyledTableHandler, addTitleDecorationDefinition, addTitleDecorationHandler, addPageIndicatorDefinition, addPageIndicatorHandler, setBackgroundGradientDefinition, setBackgroundGradientHandler, } from './beautify-advanced';
