...
export { setSlideBackgroundDefinition, setSlideBackgroundHandler, setBackgroundColorDefinition, setBackgroundColorHandler, setBackgroundImageDefinition, setBackgroundImageHandler, duplicateShapeDefinition, duplicateShapeHandler, setShapeZOrderDefinition, setShapeZOrderHandler, } from './background';
export { deleteShapeDefinition, deleteShapeHandler, getShapesDefinition, getShapesHandler, setShapePositionDefinition, setShapePositionHandler, alignShapesDefinition, alignShapesHandler, distributeShapesDefinition, distributeShapesHandler, groupShapesDefinition, groupShapesHandler, } from './shape-basic';
...
export { getSlideMasterDefinition, getSlideMasterHandler, setMasterBackgroundDefinition, setMasterBackgroundHandler, addMasterElementDefinition, addMasterElementHandler, addPptHyperlinkDefinition, addPptHyperlinkHandler, removePptHyperlinkDefinition, removePptHyperlinkHandler, findPptTextDefinition, findPptTextHandler, replacePptTextDefinition, replacePptTextHandler, startSlideShowDefinition, startSlideShowHandler, } from './misc';
export { insertPptTableDefinition, insertPptTableHandler, setPptTableCellDefinition, setPptTableCellHandler, getPptTableCellDefinition, getPptTableCellHandler, } from './table';
