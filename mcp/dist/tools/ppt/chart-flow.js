...
exports.chartFlowTools = exports.createTimelineHandler = exports.createTimelineDefinition = exports.createOrgChartHandler = exports.createOrgChartDefinition = exports.createFlowChartHandler = exports.createFlowChartDefinition = exports.setPptChartStyleHandler = exports.setPptChartStyleDefinition = exports.setPptChartDataHandler = exports.setPptChartDataDefinition = exports.insertPptChartHandler = exports.insertPptChartDefinition = void 0;
 ...
 */
exports.createFlowChartDefinition = {
...
const createFlowChartHandler = async (args) => {
    const { slideIndex, nodes, connections } = args;
    try {
        const response = await wps_client_1.wpsClient.executeMethod('createFlowChart', { slideIndex, nodes, connections: connections || [] }, wps_1.WpsAppType.PRESENTATION);
        if (response.success && response.data) {
            return {
                id: (0, uuid_1.v4)(),
                success: true,
...
exports.createFlowChartHandler = createFlowChartHandler;
// ==================== 5. 创建组织架构图 ====================
/**
 * 创建组织架构图
 * 根据层级数据自动生成组织架构图
 */
exports.createOrgChartDefinition = {
...
exports.createOrgChartHandler = createOrgChartHandler;
// ==================== 6. 创建时间线 ====================
/**
 * 创建时间线
 * 根据事件数据在幻灯片中生成时间线图形
 */
exports.createTimelineDefinition = {
...
const createTimelineHandler = async (args) => {
    const { slideIndex, events } = args;
    try {
        const response = await wps_client_1.wpsClient.executeMethod('createTimeline', { slideIndex, events }, wps_1.WpsAppType.PRESENTATION);
        if (response.success && response.data) {
            return {
                id: (0, uuid_1.v4)(),
                success: true,
